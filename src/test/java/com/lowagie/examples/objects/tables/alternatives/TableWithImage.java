...
public class TableWithImage {
	...
	public static void main(String[] args) {
		...
		try {
			...
			table.addCell(new Cell(Image.getInstance(ResourceLoader.fileFromClassPath("otsoe.jpg"))));
			table.addCell(new Cell(Image.getInstance(ResourceLoader.fileFromClassPath("iText.gif"))));
			Cell c1 = new Cell();
			c1.add(Image.getInstance(ResourceLoader.fileFromClassPath("iText.gif")));
			table.addCell(c1);
			Cell c2 = new Cell();
			c2.add(Image.getInstance(ResourceLoader.fileFromClassPath("otsoe.jpg")));
			table.addCell(c2);
			document.add(table);
